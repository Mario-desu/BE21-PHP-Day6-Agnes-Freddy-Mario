...
<html>
    ...
    <body>
        <fieldset>
            <legend class='h2'>Book a room <img class='img-thumbnail rounded-circle' src='../pictures/<?php echo $image ?>' alt="<?php echo $name ?>"></legend>
            <form action="actions/a_booking.php"  method="post" enctype="multipart/form-data">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-success" type= "submit">Book room</button></td>
                        <td><a href= "booking_dash.php"><button class="btn btn-warning" type="button">Back</button></a></td>
                    </tr>
                </table>
            </form>
        </fieldset>
